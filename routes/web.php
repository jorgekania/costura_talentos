...
Route::get('/vagas/{title}/{id}', [FashionVacanciesController::class, 'vacancy'])->name('vacancy');
Route::get('/vagas-{specialization}', [FashionVacanciesController::class, 'index'])->name('vacancies');
