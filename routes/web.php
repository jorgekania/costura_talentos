...
Route::controller(AuthCompanyController::class)
    ...
    ->group(function () {
        ...
        Route::middleware("company")->group(function () {
            ...
            Route::get("my-candidates/{candidates?}", [CompanyController::class,"myCandidates"])->name(".myCandidates");
            Route::get("my-candidates/candidate/{candidate}", [CompanyController::class,"candidate"])->name(".candidate");
