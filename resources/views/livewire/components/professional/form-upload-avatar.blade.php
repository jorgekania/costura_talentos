        ...
        <div class="flex flex-wrap my-10 items-center">
            <div class="w-full lg:w-9/12 px-4">
                <div class="flex items-center space-x-6">
                    <div class="shrink-0">
                        @if($avatar)
                            <img class="h-36 w-36 object-cover rounded-full"src="{{ $avatar->temporaryUrl() }}" />
                        @else
                            <img class="h-36 w-36 object-cover rounded-full"src="{{ Storage::url('professional_avatars/user-icon.png') }}" />
                        @endif
                    </div>
                ...
                <div class="w-full lg:w-3/12 px-4 text-right">
                    <button
                        ...
                        type="button" x-on:click="$wire.uploadAvatar('{{ $professional->id }}')">
