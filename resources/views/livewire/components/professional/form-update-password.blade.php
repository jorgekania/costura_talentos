<div class="w-3/5 m-auto">
    @if ($professional->provider && is_null($professional->password))
        ...
        <div class="flex flex-wrap mb-10">
            ...
            <p class="mb-5">Se ainda quiser criar uma senha apra acesso via seu email e esta senha, clie abaixo e enviaremos um senha provisória para <span class="font-extrabold">{{ $professional->email }}</span></p>
