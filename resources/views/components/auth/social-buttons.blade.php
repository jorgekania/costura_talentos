<a href="{{ route('professional.redirectToProvider', 'google') }}"
    ...
    <span class="ml-4 text-primary-blue">
        Google
    </span>
</a>
...
{{-- <div class="flex mb-3">
    <a href=""
        ...
        <div class="bg-white p-1 rounded-full">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0,0,256,256" class="w-4">
                <g fill="#8bb7f0" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt"
